// Code generated by "callbackgen -type User -generateRemove -lockField mu -interface ./example/user"; DO NOT EDIT.
...
type UserEventHub interface {
	...
	OnMessageByRequestID(requestID RequestID, cb TextMessageCallback)
	RemoveOnMessageByRequestID(requestID RequestID, cb TextMessageCallback)

	OnPatch(cb func(a1 int, b1 int))
	RemoveOnPatch(cb func(a1 int, b1 int))
}
